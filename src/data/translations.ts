...
const es = {
  ...
  contact: {
    title: 'Hablemos',
    intro: '¿Tienes una idea o un proyecto en mente? Escríbeme.',
    channelsLabel: 'Datos de contacto',
    whatsapp: 'WhatsApp',
    email: 'Correo',
    github: 'GitHub',
    form: {
      ...
      emailDirectly: 'Escribir por correo',
      mailtoOpened: 'Se abrió tu aplicación de correo con el mensaje listo para enviar.',
      mailSubject: (name: string) => `Mensaje de ${name} desde el portafolio`,
      errors: {
...
const en: Translation = {
  ...
  contact: {
    title: "Let's talk",
    intro: 'Have an idea or project in mind? Send me a message.',
    channelsLabel: 'Contact details',
    whatsapp: 'WhatsApp',
    email: 'Email',
    github: 'GitHub',
    form: {
      ...
      emailDirectly: 'Send by email',
      mailtoOpened: 'Your email app opened with the message ready to send.',
      mailSubject: (name: string) => `Message from ${name} via the portfolio`,
      errors: {
